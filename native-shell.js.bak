/* V76T Native App Shell Navigation
...
(function nativeAppShellV76t() {
    if (window.__IPSC_NATIVE_APP_SHELL_V76T) return;
    window.__IPSC_NATIVE_APP_SHELL_V76T = true;
    ...
    function resizeFrame(frame) {
        ...
        try {
            ...
            frame.style.height = Math.max(400, h + 4) + "px";
        } catch (_) {}
    }
    ...
    function routeTo(rawView, opts) {
        ...
        Object.keys(frames).forEach(function (k) {
            if (k !== view.key) frames[k].classList.remove("is-active");
        });
    ...
    function warmHtmlCache() {
        var warm = ["index.html", "marktplatz.html", "mein-planer.html", "community.html", "freie-matches.html", "schiessbuch.html", "tools.html", "analytics.html", "wiederladen.html"];
        var i = 0;
        function next() {
    ...
    window.IPSCNativeShellV76t = { routeTo: routeTo, syncTheme: syncThemeToFrames };
})();
