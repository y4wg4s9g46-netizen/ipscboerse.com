        ...
        <div class="modal" id="auth-modal">
            <div class="modal-content">
                ...
                <div id="modal-login-view">
                    ...
                    <div class="social-login-separator" style="margin: 20px 0; text-align: center; border-top: 1px solid var(--border-color); padding-top: 15px;">
                        <p style="font-size: 13px; color: var(--text-muted); margin-bottom: 10px;">Oder direkt anmelden mit:</p>
                        
                        <button type="button" onclick="loginWithGoogle()" class="btn-social-google" style="margin-bottom: 8px;">
                        ...
                        <button type="button" onclick="loginWithApple()" class="btn-social-apple">
