(function() {
    const injectHeader = () => {
        ...
        style.innerHTML = `
            /* --- DESKTOP STYLES (Exakt wie Backup) --- */
            ...
            /* --- TABLET STYLES (Exakt wie Backup) --- */
            ...
            /* --- MOBILE STYLES: DAUMEN NAVIGATION FÜR ALLE HANDYS (App & Browser) --- */
            @media (max-width: 768px) {
                /* Header massiv verkleinern */
                header { 
                    padding: calc(env(safe-area-inset-top) + 12px) 12px 12px 12px !important; 
                }
                header .header-logo-link img { height: 32px !important; }
                header h1 { font-size: 16px !important; margin-bottom: 2px !important; }
                header p[data-txt="sub-title"] { display: none !important; } /* Untertitel weg für Platz */
                ...
                /* 🚀 DIE DAUMEN NAVIGATION FIXIERT AM BODEN */
                header .main-nav { 
                    ...
                    border-radius: 0 !important; /* Ecken glätten */
                }
                ...
                /* Content Padding anpassen, damit nichts verdeckt wird */
                body { padding-bottom: 90px !important; }
                .floating-action-bar { bottom: calc(90px + env(safe-area-inset-bottom)) !important; }
            }
        `;
