(function() {
    const injectHeader = () => {
        ...
        // 🌟 Aufbau des originalen HTML-Gerüsts wie im Video
        header.innerHTML = `
        ...
        style.innerHTML = `
            ...
            /* ==========================================================================
               📱 RESPONSIVE-STRUKTUR: NUR MOBIL & TABLET WIRD HIER ANGEPASST
               ========================================================================== */
            @media (max-width: 1024px) {
                /* 1. Header oben bleibt exakt so edel, wird aber flacher (Abstände verringert) */
                header { 
                    padding: calc(env(safe-area-inset-top) + 10px) 12px 10px 12px !important; 
                    display: flex; 
                    flex-direction: column; 
                    align-items: center; 
                    pointer-events: none !important; /* Behebt das Klick-Problem unter iOS */
                }
                
                /* Macht Klicks im Header wieder möglich */
                header .header-logo-link, header .header-controls { 
                ...
                /* 2. NUR die Menüleiste fliegt ganz nach unten an den Bildschirmrand */
                header .main-nav { 
                    ...
                    /* Perfekt berechneter iOS Home-Bar-Abstand */
                ...
                header .main-nav a { padding: 10px 18px !important; font-size: 13px !important; border-radius: 24px !important; scroll-snap-align: start !important; }
                
                /* Genügend Platz unten schaffen, damit der Seiteninhalt nicht überlappt */
